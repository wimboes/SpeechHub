...
flags.DEFINE_string("name","untied_n_best_cbow_mean_lstm_2_medium","name")

flags.DEFINE_string("input_path", input_path, "data_path")
flags.DEFINE_string("model_name", "untied_models_medium", "model_name")
...
def main(_):
    ...
    output_dir = os.path.join(FLAGS.save_path, FLAGS.model_name + '2', FLAGS.name)
...
#    print(len(fv_files))
#    print(fv_files)
    for i in range(len(fv_files)-29,len(fv_files)):
        print(fv_files[i])
