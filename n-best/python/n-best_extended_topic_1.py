...
class ds_extended_topic_1_model(object):
    def __init__(self, is_training, config, input_sentence, input_continuous, topic_matrix, initializer_reg, initializer_lda, initializer_int):
        ...
        batch_size = input_continuous.batch_size
...
def main(_):
    ...
    param1 =  ['num_layers_reg','num_layers_lda','num_layers_int','hidden_size_int','hidden_size_lda', 'hidden_size_reg', 'embedded_size_reg', 'embedded_size_lda']
