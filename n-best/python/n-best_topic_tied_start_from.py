...
flags.DEFINE_string("name","tied_n_best_topic_medium2","name")

flags.DEFINE_string("input_path", input_path, "data_path")
flags.DEFINE_string("model_name", "tied_models_medium", "model_name")
...
def main(_):
    ...
    for i in range(len(fv_files)-18,len(fv_files)):
        print(fv_files[i])
