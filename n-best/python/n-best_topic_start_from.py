...
flags.DEFINE_string("name","tied_models_n_best_topic_large4","name")
...
def main(_):
    ...
    output_dir = os.path.join(FLAGS.save_path, FLAGS.model_name + '4', FLAGS.name)
    ...
    for i in range(240,len(fv_files)):
        print(fv_files[i])
