...
flags.DEFINE_integer("embedded_size", 6, "embedded_size")
...
class PTBInput(object):
    ...
    def __init__(self, config, data, name=None):
        ...
        self.input_data, self.targets, self.history = reader_cbow_input.ptb_producer(data, batch_size, num_steps, num_history, name=name)
...
def main(_):
    ...
    raw_data = reader_cbow_input.ptb_raw_data(FLAGS.data_path)
