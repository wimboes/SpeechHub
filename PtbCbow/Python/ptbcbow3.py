...
flags.DEFINE_string("test_name","cbow3","test_name")
...
class PTBModel(object):
    ...
    def __init__(self, is_training, config, input_):
        ...
        if is_training and config.keep_prob < 1:
            ...
            #inputs_cbow = tf.nn.embedding_lookup(embedding, input_.history) ##effect hiervan nagaan!
...
#        print(inputs[0].get_shape())
    ...
    def length_of_seq(self,sequence):
        ...
        length = tf.reduce_mean(length)                        #extra toegevoegd 
...
def main(_):
    ...
    raw_data = reader_cbow.ptb_raw_data(FLAGS.data_path)
