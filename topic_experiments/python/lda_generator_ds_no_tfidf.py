...
def lda_generate_model(sentences_per_document, nb_topics, data_path, lda_save_path, no_below, no_above):
    ...
    new_dict.filter_extremes(no_below=no_below,no_above=no_above,keep_n=None)
...
lda = lda_generate_model(sentences_per_document, nb_topics, data_path, lda_save_path)
