...
jobfile.write('RequestMemory    = 1G \n')
jobfile.write('+RequestWalltime = 3600 \n')
jobfile.write('\n')
jobfile.write('request_GPUs = 1 \n')
jobfile.write('requirements = (CUDACapability >= 3.5) && (machineowner == "PSI/Spraak") \n')
jobfile.write('\n')
