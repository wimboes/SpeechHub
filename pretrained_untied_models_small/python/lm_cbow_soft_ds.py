...
flags.DEFINE_integer("embedded_size_reg", 32, "embedded_size_reg")
flags.DEFINE_integer("embedded_size_cbow", 32, "embedded_size_cbow")
...
class ds_cbow_sentence_model(object):
	...
	if FLAGS.pretrained == "yes":
            input_path = os.path.join(os.path.split(os.path.split(python_path)[0])[0],'input')
	    embedding_np= np.load(os.path.join(input_path,"embedding_32.npy"))	
