...
def main(_):
    ...
    with tf.Graph().as_default():
        ...
        with tf.name_scope("train"):
            train_data = reader.ds_data_with_history(config.batch_size, config.num_history, FLAGS.data_path, train_name)
        ...
        with sv.managed_session() as session:
            ...
            for i in range(pos_epoch):
                m.input.next_batch(1) #Om op juiste plaats terug te beginnen in data, eventueel anders als reader aangepast is...
