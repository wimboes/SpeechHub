...
class PTBInput(object):
    ...
    def __init__(self, config, data, name=None):
        ...
        self.input_data, self.targets = LDA_reader.ptb_producer(data, batch_size, num_steps, name=name)
...
def main(_):
    ...
    raw_data = LDA_reader.ptb_raw_data_lda(FLAGS.data_path)
    #lda = models.LdaModel.load('lda.model')
    #dictionary = corpora.Dictionary.load('dict.dictionary')
    train_data, valid_data, test_data, _, topic_array = raw_data 
