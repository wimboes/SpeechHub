...
filename = '/home/robbe/SpeechHub/LDA_DS/Input/ds.test.txt'
...
def ptb_raw_data_lda(data_path=None, text_data, vocab_size, lda_path='lda.model', dict_path='dictionary.dict'):
